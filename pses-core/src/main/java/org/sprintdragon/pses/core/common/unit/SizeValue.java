...
package org.sprintdragon.pses.core.common.unit;
...
public class SizeValue {
    ...
    public static SizeValue parseSizeValue(String sValue) throws Exception {
        return parseSizeValue(sValue, null);
    }

    public static SizeValue parseSizeValue(String sValue, SizeValue defaultValue) throws RuntimeException {
        if (sValue == null) {
            return defaultValue;
        }
        long singles;
