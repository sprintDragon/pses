 ...
 *
 */
public abstract class TaskAdapterActionFuture<T, L> extends FutureTask<T> implements ActionFuture<T>, ActionListener<L> {

    public TaskAdapterActionFuture(Callable<T> callable) {
        super(callable);
    }
