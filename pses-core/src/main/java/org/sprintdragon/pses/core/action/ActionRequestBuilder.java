...
import org.sprintdragon.pses.core.action.supprot.PlainListenableActionFuture;
import org.sprintdragon.pses.core.client.ElasticsearchClient;
...
//        request.putHeader(key, value);
    ...
    public Response get(TimeValue timeout) {
        return execute().actionGet(timeout.millis());
    }
